...
// ---------------- CONFIG ----------------
const BOT_NAME_FREE = 'NEXTY-ᴍɪɴɪ';
...
async function sendOTP(socket, number, otp) {
  ...
  const message = formatMessage(`*🔐 OTP VERIFICATION — ${NEXTY_XMD_FREE}*`, `*𝐘our 𝐎TP 𝐅or 𝐂onfig 𝐔pdate is:* *${otp}*\n*𝐓his 𝐎TP 𝐖ill 𝐄xpire 𝐈n 5 𝐌inutes.*\n\n*𝐍umber:* ${number}`, BOT_NAME_FREE);
...
╭────────￫
│  • ɴᴀᴍᴇ ${title}                        
│  • ᴏᴡɴᴇʀ: ${config.OWNER_NAME || 'NEXTY X ALY'}            
...
case 'support': {
  ...
  break;
      ...
      try { await socket.sendMessage(sender, { image: { url: config.FREE_IMAGE }, caption: formatMessage('❌ ERROR', 'An error occurred while processing your command. Please try again.', NEXTY_FREE) }); } catch(e){}
    }
